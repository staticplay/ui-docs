examples.lang = {
	copy: function (pre, value) {
		...
		function parseColor(color) {
			...
			colorNode.className = 'color-swatch';
      var chipNode = colorNode.appendChild(document.createElement('div'));
			chipNode.className = 'color';
			chipNode.style.color = color.color;
      chipNode.appendChild(document.createTextNode("Aa"));
        ...
        var hexNode = colorNode.appendChild(document.createElement('div'));
        hexNode.className = 'color-hex';
        hexNode.appendChild(document.createTextNode(color.color));
			});
	...
	color: function (pre, value) {
      ...
      var chipNode = colorNode.appendChild(document.createElement('div'));
			chipNode.className = 'color';
			chipNode.style.backgroundColor = color.color;
			/* var contrastColor = contrast(color.color);
			colorNode.style.color = contrastColor;
			colorNode.style.textShadow = '0 0 1px ' + (contrastColor === '#ffffff' ? '#000000' : '#ffffff'); */
